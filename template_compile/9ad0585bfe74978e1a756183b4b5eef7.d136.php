                    ...
                    <div class="table-responsive">
                        <table id="data_table" class="table table-striped display dataTable responsive" role="grid">
                            <thead>
                                <tr>
                                    <?php 
$_fh2_data = (isset($this->scope["colunas_datatable"]) ? $this->scope["colunas_datatable"] : null);
if ($this->isTraversable($_fh2_data) == true)
{
	foreach ($_fh2_data as $this->scope['coluna'])
	{
...
?>
                                    ...
                                    <?php 
$_fh4_data = (isset($this->scope["linhas_datatable"]) ? $this->scope["linhas_datatable"] : null);
if ($this->isTraversable($_fh4_data) == true)
{
	foreach ($_fh4_data as $this->scope['linhas'])
	{
/* -- foreach start output */
?>
                                        ...
                                        <tr role="row" class="gradeA odd">
                                            <?php 
$_fh3_data = (isset($this->scope["linhas"]) ? $this->scope["linhas"] : null);
if ($this->isTraversable($_fh3_data) == true)
{
	foreach ($_fh3_data as $this->scope['coluna_linha\''])
	{
/* -- foreach start output */
?>
